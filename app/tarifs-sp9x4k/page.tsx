  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="section-title">Image <em>Personnelle</em></div>
        <div className="cards">
          <div className="card">
          ...
          <div className="card">
            <div className="card-left">
              <div className="card-name">Visuel réseaux</div>
              <div className="card-livrable">1 format · post ou story · livraison 24-48h</div>
            ...
            <div className="card-right">
              <div className="card-prix-split">
                <div className="card-prix-split-item">
                  <div className="card-prix" style={{fontSize:'28px'}}>40 €</div>
                  <div className="card-prix-label">photo fournie</div>
                </div>
                <div className="card-prix-split-divider">
                  <div className="card-prix" style={{fontSize:'28px', color:'#888787'}}>25 €</div>
          ...
          <div className="card featured">
            <div className="card-left">
              <div className="card-name">Pack démarrage 3 mois</div>
              <div className="card-livrable">1 session photo + 1 Reel/mois · 30 photos · image cohérente dans la durée</div>
            ...
            <div className="card-right">
              <div className="card-prix">180 €</div>

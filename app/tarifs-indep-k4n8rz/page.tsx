...
export const metadata: Metadata = {
  title: 'Tarifs Indépendants ı Alexis Bossy',
  robots: {
    index: false,
    follow: false,
  },
...
export default function TarifsIndepPage() {
  return (
    <>
      <style>{`
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-prix-split-item { text-align: right; }

        .card-prix-split-divider {
      ...
      <div className="page">
        ...
        <div className="section-label">
          ...
          <span className="section-label-text">Prestations</span>
        </div>
        <div className="section-title">Com&apos; <em>Digitale</em></div>
        <div className="cards">
          <div className="card">
          ...
          <div className="card">
            ...
            <div className="card-right">
              <div className="card-prix">130 €</div>
              <div className="card-prix-label">à l&apos;unité</div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-left">
              <div className="card-name">Visuel réseaux à l&apos;unité</div>
              <div className="card-livrable">1 format · annonce, promo, événement · livraison 24-48h</div>
              <div className="card-tags"><span className="tag tag-graphisme">Graphisme</span></div>
            </div>
            <div className="card-right">
              <div className="card-prix-split">
                <div className="card-prix-split-item">
                  <div className="card-prix" style={{fontSize:'28px'}}>55 €</div>
                  <div className="card-prix-label">photo fournie</div>
                </div>
                <div className="card-prix-split-divider">
                  <div className="card-prix" style={{fontSize:'28px', color:'#888787'}}>35 €</div>
                  <div className="card-prix-label">si shooting réalisé par moi</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card featured">
            <div className="card-left">
              <div className="card-name">Pack mensuel complet</div>
              <div className="card-livrable">1 session photo · 1 Reel · 4 visuels réseaux · tout géré</div>
              <div className="card-tags">
                <span className="tag tag-pack">Pack</span>
                <span className="tag tag-mois">/mois</span>
              </div>
            </div>
            <div className="card-right">
              <div className="card-prix">280 €</div>
